...
class SettingsVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func defaultSite() {
        let MainScreenStoryboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        let DefaultSiteVC = MainScreenStoryboard.instantiateViewController(withIdentifier: "kDefaultSiteVC") as! DefaultSiteVC
        self.navigationController?.pushViewController(DefaultSiteVC, animated: true)
    }
    func saveUserName() {
        let MainScreenStoryboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        let SaveUserNameVC = MainScreenStoryboard.instantiateViewController(withIdentifier: "kSaveUserNameVC") as! SaveUserNameVC
        self.navigationController?.pushViewController(SaveUserNameVC, animated: true)
    }
    
    func displayTime() {
        let MainScreenStoryboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        let DisplayTimeViewController = MainScreenStoryboard.instantiateViewController(withIdentifier: "kDisplayTimeViewController") as! DisplayTimeVC
